...
import Search from './searchPanel/pure_function_search/components/search/Search';
import OrderInfo from './searchPanel/pure_function_search/components/orderInfo/OrderInfo';
