...
const GroupBtn = () => {
  ...
  const { submitValueCalc, deleteTab, print, activeTab } = useContext(MainContext);
  interface type {
    type: string,
    text: string,
  ...
  const buttons: Array<type> = useMemo(() => [
    {
      type: 'tara',
      text: 'тара',
      renderIcon: <Speed />,
    ...
    },
    {
      ...
      modalContent: <ModalClose deleteTab={deleteTab} modalClose={() => setModalContent(null)} activeTab={ activeTab } />,
    }
